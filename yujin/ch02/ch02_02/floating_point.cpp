...
int main() {
  float float_value = 9.87654321f;  // 4바이트 부동소수점
  double double_value = 9.87654321987654321;    // 8바이트 부동소수점
  long double long_double_value = 9.87654321987654321l; // 8바이트 부동소수점, g++에서는 16바이트
